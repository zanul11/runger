...
<style>
  ...
  .dash-hi{font-family:'Archivo',sans-serif;font-weight:900;font-size:34px;line-height:1;letter-spacing:-.01em}
  .dash-sub{color:var(--text-soft);font-size:14px;margin-top:8px}
  .dash-logout{background:transparent;border:1px solid rgba(255,255,255,.25);color:#fff;font-family:'Archivo',sans-serif;font-weight:700;font-size:12px;letter-spacing:.04em;text-transform:uppercase;padding:11px 18px;border-radius:999px;cursor:pointer;transition:background .2s}
  ...
  .dash-card h3{font-family:'Archivo',sans-serif;font-weight:800;font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--red);margin-bottom:16px}
  ...
  .reg-name{font-family:'Archivo',sans-serif;font-weight:800;font-size:17px}
  .reg-meta{font-size:12.5px;color:var(--text-mute);margin-top:3px}
  .badge{font-family:'Archivo',sans-serif;font-weight:700;font-size:10.5px;letter-spacing:.1em;text-transform:uppercase;padding:6px 12px;border-radius:999px}
  ...
  .pick .d{font-family:'Archivo',sans-serif;font-weight:900;font-size:24px;line-height:1}
  .pick .n{font-size:13px;color:var(--text-soft);margin-top:4px}
  .pick .price{font-family:'Archivo',sans-serif;font-weight:800;font-size:14px;color:var(--red);margin-top:6px}
  .pick-btn{background:var(--red);color:#fff;font-family:'Archivo',sans-serif;font-weight:700;font-size:12px;letter-spacing:.04em;text-transform:uppercase;padding:12px 20px;border-radius:10px;border:none;cursor:pointer;white-space:nowrap;transition:background .2s}
  .pick-btn:hover{background:var(--red-deep)}
  .pick-done{font-family:'Archivo',sans-serif;font-weight:700;font-size:12px;letter-spacing:.04em;text-transform:uppercase;color:#22c55e;white-space:nowrap}
