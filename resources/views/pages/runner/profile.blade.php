...
<style>
  ...
  .prof-av{width:76px;height:76px;border-radius:50%;background:linear-gradient(135deg,#2A4FC8,#0F2680);display:flex;align-items:center;justify-content:center;font-family:'Archivo',sans-serif;font-weight:900;font-size:30px;color:#fff;box-shadow:0 10px 26px rgba(27,63,174,.45)}
  .prof-name{font-family:'Archivo',sans-serif;font-weight:900;font-size:22px;line-height:1}
  ...
  .btn-logout{width:100%;margin-top:16px;background:transparent;border:1px solid rgba(229,57,53,.5);color:var(--red);font-family:'Archivo',sans-serif;font-weight:700;font-size:13px;letter-spacing:.04em;text-transform:uppercase;padding:14px;border-radius:12px;cursor:pointer;transition:background .2s}
