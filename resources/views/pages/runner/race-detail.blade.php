...
<style>
  ...
  .evd-dist{display:inline-block;background:#fff;color:#0F2680;font-family:'Archivo',sans-serif;font-weight:900;font-size:26px;padding:5px 16px;border-radius:10px;line-height:1}
  .evd-date{display:inline-block;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.3);padding:7px 14px;border-radius:10px;font-family:'Archivo',sans-serif;font-weight:700;font-size:13px;margin-top:10px}

  .evd-card{background:#fff;color:#101010;border-radius:16px;padding:18px 20px;margin-bottom:16px}
  .evd-title{font-family:'Archivo',sans-serif;font-weight:800;font-size:18px;text-align:center}
  .evd-sub{text-align:center;color:#888;font-size:13px;margin-top:2px}
  .evd-h{font-family:'Archivo',sans-serif;font-weight:800;font-size:17px;margin:18px 0 12px}
  ...
  .evd-status{display:inline-block;font-family:'Archivo',sans-serif;font-weight:700;font-size:10px;letter-spacing:.08em;text-transform:uppercase;padding:5px 11px;border-radius:999px;margin-left:8px}
  ...
  .qr-card .qcap{font-family:'Archivo',sans-serif;font-weight:700;font-size:13px;color:#101010;letter-spacing:.02em}

  .evd-actions{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:8px}
  .evd-act{display:inline-flex;align-items:center;justify-content:center;background:var(--blue);color:#fff;font-family:'Archivo',sans-serif;font-weight:700;font-size:13px;letter-spacing:.04em;text-transform:uppercase;padding:14px;border-radius:999px;border:none;cursor:not-allowed;opacity:.85}
  ...
  .pay-cta-h{font-family:'Archivo',sans-serif;font-weight:800;font-size:18px;color:var(--text)}
  .pay-cta p{font-size:13px;color:var(--soft);margin:8px auto 14px;max-width:34ch;line-height:1.5}
  .pay-cta-amt{font-family:'Archivo',sans-serif;font-weight:900;font-size:24px;color:var(--blue);margin-bottom:16px}
  .pay-cta-btn{width:100%;background:var(--blue);color:#fff;font-family:'Archivo',sans-serif;font-weight:700;font-size:14px;letter-spacing:.04em;text-transform:uppercase;padding:15px;border-radius:12px;border:none;cursor:pointer;transition:background .2s,transform .15s}
